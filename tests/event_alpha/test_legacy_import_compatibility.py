...
RETAINED_OLD_SHIM_MODULES = (
    ('crypto_rsi_scanner.event_alpha_source_coverage', 'crypto_rsi_scanner.event_alpha.radar.source_coverage'),
    ...
    ('crypto_rsi_scanner.event_alpha_namespace_status', 'crypto_rsi_scanner.event_alpha.namespace.status'),
    ('crypto_rsi_scanner.event_llm_extract_eval', 'crypto_rsi_scanner.event_alpha.radar.llm.extract_eval'),
    ('crypto_rsi_scanner.event_llm_eval', 'crypto_rsi_scanner.event_alpha.radar.llm.eval'),
    ('crypto_rsi_scanner.event_incident_graph', 'crypto_rsi_scanner.event_alpha.radar.incident_graph'),
    ('crypto_rsi_scanner.event_identity', 'crypto_rsi_scanner.event_alpha.radar.identity'),
    ('crypto_rsi_scanner.event_graph', 'crypto_rsi_scanner.event_alpha.radar.graph'),
    ('crypto_rsi_scanner.event_resolver', 'crypto_rsi_scanner.event_alpha.radar.resolver'),
    ('crypto_rsi_scanner.event_price_history', 'crypto_rsi_scanner.event_alpha.radar.price_history'),
    ('crypto_rsi_scanner.event_catalyst_frame_validator', 'crypto_rsi_scanner.event_alpha.radar.catalyst_frame_validator'),
    ('crypto_rsi_scanner.event_anomaly_state', 'crypto_rsi_scanner.event_alpha.radar.anomaly_state'),
    ('crypto_rsi_scanner.event_anomaly_scanner', 'crypto_rsi_scanner.event_alpha.radar.anomaly_scanner'),
    ('crypto_rsi_scanner.event_market_units', 'crypto_rsi_scanner.event_alpha.radar.market_units'),
    ('crypto_rsi_scanner.event_llm_budget', 'crypto_rsi_scanner.event_alpha.radar.llm.budget'),
    ('crypto_rsi_scanner.event_llm_catalyst_frames_eval', 'crypto_rsi_scanner.event_alpha.radar.llm.catalyst_frames_eval'),
    ('crypto_rsi_scanner.event_source_reliability', 'crypto_rsi_scanner.event_alpha.providers.source_reliability'),
    ('crypto_rsi_scanner.event_cache', 'crypto_rsi_scanner.event_alpha.artifacts.cache'),
    ('crypto_rsi_scanner.event_alpha_explain', 'crypto_rsi_scanner.event_alpha.artifacts.explain'),
    ('crypto_rsi_scanner.event_alpha_quality_fields', 'crypto_rsi_scanner.event_alpha.outcomes.quality_fields'),
    ('crypto_rsi_scanner.event_alpha_outcomes', 'crypto_rsi_scanner.event_alpha.outcomes.outcome_artifacts'),
    ('crypto_rsi_scanner.event_alpha_eval', 'crypto_rsi_scanner.event_alpha.outcomes.eval'),
    ('crypto_rsi_scanner.event_alpha_burn_in_checklist', 'crypto_rsi_scanner.event_alpha.outcomes.burn_in_checklist'),
    ...
    ('crypto_rsi_scanner.event_alpha_health_guard', 'crypto_rsi_scanner.event_alpha.config.health_guard'),
    ('crypto_rsi_scanner.event_alpha_scheduler', 'crypto_rsi_scanner.event_alpha.config.scheduler'),
    ('crypto_rsi_scanner.event_alpha_environment_doctor', 'crypto_rsi_scanner.event_alpha.doctor.environment'),
    ('crypto_rsi_scanner.event_provider_status', 'crypto_rsi_scanner.event_alpha.notifications.provider_status'),
    ('crypto_rsi_scanner.event_alpha_missed', 'crypto_rsi_scanner.event_alpha.radar.missed'),
    ('crypto_rsi_scanner.event_alpha_reason_text', 'crypto_rsi_scanner.event_alpha.artifacts.reason_text'),
    ('crypto_rsi_scanner.event_clock', 'crypto_rsi_scanner.event_core.clock'),
    ('crypto_rsi_scanner.event_models', 'crypto_rsi_scanner.event_core.models'),
)
