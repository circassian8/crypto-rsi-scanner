...
def _cryptopanic_stats_for_pipeline_result(
    ...
    *,
    ...
    from .cli.services import event_alpha as _event_alpha_service
...
def event_alpha_notify_go_no_go(
    ...
    *,
    ...
    from .cli.services import event_alpha as _event_alpha_service
    return _event_alpha_service.event_alpha_notify_go_no_go(verbose, profile_name=profile_name, artifact_namespace=artifact_namespace, include_test_artifacts=include_test_artifacts, include_legacy_artifacts=include_legacy_artifacts)
...
def cli() -> None:
    """Compatibility wrapper for the package CLI entrypoint."""
