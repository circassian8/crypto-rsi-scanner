    ...
    *,
    ...
    return "\n".join([
        ...
        *warning_lines,
        ...
        "3. Edit `review_template.csv` with `review_status`, `reviewed_by`, `reviewed_at`, `human_label`, `human_notes`, any human event-time confirmation, and any missing outcomes.",
