...
EVENT_DISCOVERY_CRYPTOPANIC_BASE_URL = os.getenv(
    ...
    "https://cryptopanic.com/api/growth/v2",
)
EVENT_DISCOVERY_CRYPTOPANIC_PLAN = os.getenv("RSI_EVENT_DISCOVERY_CRYPTOPANIC_PLAN", "growth")
...
DECISION_RADAR_MIN_OBSERVATION_SPACING_MINUTES = int(
    os.getenv("RSI_DECISION_RADAR_MIN_OBSERVATION_SPACING_MINUTES", "60")
)
...
# Crypto Radar Decision Model v2 is an operator-facing research layer.  It is
# deliberately separate from the legacy Event Alpha alert router so enabling
# transparent actionability previews cannot enable sends or create fade states.
EVENT_ALPHA_DECISION_MODEL_V2_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ENABLED",
    True,
)
EVENT_ALPHA_DECISION_MODEL_V2_PREVIEW_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_PREVIEW_ENABLED",
    True,
)
EVENT_ALPHA_DECISION_MODEL_V2_MARKET_LED_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_MARKET_LED_ENABLED",
    True,
)
EVENT_ALPHA_DECISION_MODEL_V2_CATALYST_LED_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_CATALYST_LED_ENABLED",
    True,
)
_EVENT_ALPHA_RSI_SIGNAL_CONTEXT_PATH_RAW = os.getenv(
    "RSI_EVENT_ALPHA_RSI_SIGNAL_CONTEXT_PATH", ""
).strip()
EVENT_ALPHA_RSI_SIGNAL_CONTEXT_PATH = (
    Path(_EVENT_ALPHA_RSI_SIGNAL_CONTEXT_PATH_RAW).expanduser()
    if _EVENT_ALPHA_RSI_SIGNAL_CONTEXT_PATH_RAW
    else None
)
EVENT_ALPHA_DECISION_MODEL_V2_ACTIONABLE_THRESHOLD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_ACTIONABLE_THRESHOLD", "65")
)
EVENT_ALPHA_DECISION_MODEL_V2_DASHBOARD_WATCH_THRESHOLD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_DASHBOARD_WATCH_THRESHOLD", "45")
)
EVENT_ALPHA_DECISION_MODEL_V2_HIGH_CONFIDENCE_THRESHOLD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_HIGH_CONFIDENCE_THRESHOLD", "80")
)
EVENT_ALPHA_DECISION_MODEL_V2_HIGH_CONFIDENCE_EVIDENCE_THRESHOLD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_HIGH_CONFIDENCE_EVIDENCE_THRESHOLD", "75")
)
EVENT_ALPHA_DECISION_MODEL_V2_RAPID_ANOMALY_THRESHOLD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_RAPID_ANOMALY_THRESHOLD", "68")
)
EVENT_ALPHA_DECISION_MODEL_V2_RAPID_ANOMALY_URGENCY_THRESHOLD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_RAPID_ANOMALY_URGENCY_THRESHOLD", "72")
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_DASHBOARD_WATCH_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_DASHBOARD_WATCH_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_ACTIONABLE_WATCH_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_ACTIONABLE_WATCH_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_HIGH_CONFIDENCE_WATCH_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_HIGH_CONFIDENCE_WATCH_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_RAPID_MARKET_ANOMALY_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_RAPID_MARKET_ANOMALY_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_FADE_EXHAUSTION_REVIEW_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_FADE_EXHAUSTION_REVIEW_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_CALENDAR_RISK_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_CALENDAR_RISK_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_RISK_WATCH_ENABLED = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_ROUTE_RISK_WATCH_ENABLED", True
)
EVENT_ALPHA_DECISION_MODEL_V2_MIN_LIQUIDITY_USD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_MIN_LIQUIDITY_USD", "250000")
)
EVENT_ALPHA_DECISION_MODEL_V2_GOOD_LIQUIDITY_USD = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_GOOD_LIQUIDITY_USD", "5000000")
)
EVENT_ALPHA_DECISION_MODEL_V2_MAX_SPREAD_BPS = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_MAX_SPREAD_BPS", "150")
)
EVENT_ALPHA_DECISION_MODEL_V2_GOOD_SPREAD_BPS = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_GOOD_SPREAD_BPS", "50")
)
EVENT_ALPHA_DECISION_MODEL_V2_MIN_VOLUME_ZSCORE = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_MIN_VOLUME_ZSCORE", "1")
)
EVENT_ALPHA_DECISION_MODEL_V2_MIN_VOLUME_TO_MARKET_CAP = float(
    os.getenv("RSI_EVENT_ALPHA_DECISION_MODEL_V2_MIN_VOLUME_TO_MARKET_CAP", "0.05")
)
EVENT_ALPHA_DECISION_MODEL_V2_SHOW_DIAGNOSTICS = _env_bool(
    "RSI_EVENT_ALPHA_DECISION_MODEL_V2_SHOW_DIAGNOSTICS",
    False,
)
EVENT_ALPHA_UNIFIED_CALENDAR_FIXTURE_PATH = Path(
    os.getenv(
        "RSI_EVENT_ALPHA_UNIFIED_CALENDAR_FIXTURE_PATH",
        "fixtures/event_discovery/unified_calendar_events.json",
    )
).expanduser()
...
_EVENT_ALPHA_DEX_GECKOTERMINAL_PATH_RAW = os.getenv(
    "RSI_EVENT_ALPHA_DEX_GECKOTERMINAL_PATH",
    "fixtures/event_dex_onchain/geckoterminal_pools.json",
)
_EVENT_ALPHA_DEX_COINGECKO_PATH_RAW = os.getenv(
    "RSI_EVENT_ALPHA_DEX_COINGECKO_PATH",
    "fixtures/event_dex_onchain/coingecko_dex_pools.json",
)
_EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH_RAW = os.getenv(
    "RSI_EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH",
    "fixtures/event_dex_onchain/defillama_protocol_fundamentals.json",
)
EVENT_ALPHA_DEX_GECKOTERMINAL_PATH = Path(_EVENT_ALPHA_DEX_GECKOTERMINAL_PATH_RAW).expanduser()
EVENT_ALPHA_DEX_COINGECKO_PATH = Path(_EVENT_ALPHA_DEX_COINGECKO_PATH_RAW).expanduser()
EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH = Path(_EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH_RAW).expanduser()
...
EVENT_ALPHA_RETENTION_DAYS_STORES = int(os.getenv("RSI_EVENT_ALPHA_RETENTION_DAYS_STORES", "45"))
...
EXCLUDE_SYMBOLS = {
    ...
    "usd1", "usdg", "usdtb", "gho", "ylds", "usx", "usyc", "eurc", "xaut", "paxg",
...
if not EVENT_ALPHA_DEX_GECKOTERMINAL_PATH.is_absolute():
    EVENT_ALPHA_DEX_GECKOTERMINAL_PATH = DATA_DIR / EVENT_ALPHA_DEX_GECKOTERMINAL_PATH
if not EVENT_ALPHA_DEX_COINGECKO_PATH.is_absolute():
    EVENT_ALPHA_DEX_COINGECKO_PATH = DATA_DIR / EVENT_ALPHA_DEX_COINGECKO_PATH
if not EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH.is_absolute():
    EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH = DATA_DIR / EVENT_ALPHA_PROTOCOL_DEFILLAMA_PATH
