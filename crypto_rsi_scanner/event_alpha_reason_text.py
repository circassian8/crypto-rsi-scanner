...
REASON_TEXT = {
    ...
    "needs_fresh_market_confirmation": "needs a fresh market/volume refresh",
    "market_confirmation": "no convincing price/volume confirmation yet",
    "market_context_stale_capped": "market confirmation was stale and capped",
    "market_context_missing": "market confirmation context is missing",
    "market_context_unknown_timestamp": "market confirmation timestamp is unknown",
    "fixture_market_context_allowed": "stale fixture market context allowed for offline test",
