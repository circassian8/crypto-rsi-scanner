...
ACCEPTED_MODEL_BUNDLE_MODULES = {
    ...
    "crypto_rsi_scanner.event_alpha.dashboard.models",
    ...
    "crypto_rsi_scanner.event_alpha.radar.calendar.models",
    ...
    "crypto_rsi_scanner.event_alpha.radar.decision_models",
