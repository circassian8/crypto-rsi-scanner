...
class BybitAnnouncementsRehearsalReport:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "exchange_announcements_path": self.exchange_announcements_path,
            "official_exchange_events_path": self.official_exchange_events_path,
            "official_listing_candidates_path": self.official_listing_candidates_path,
            "official_exchange_report_path": self.official_exchange_report_path,
            "max_pages": self.max_pages,
            "limit": self.limit,
            "requests_used": self.requests_used,
            "http_successes": self.http_successes,
            "announcements_inspected": self.announcements_inspected,
            "exchange_announcements_written": self.exchange_announcements_written,
            "official_events_written": self.official_events_written,
            "official_listing_candidates_written": self.official_listing_candidates_written,
            "supported_params": list(self.supported_params),
