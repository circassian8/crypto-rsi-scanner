"""Compatibility binder for `crypto_rsi_scanner/backtest_parts/legacy.py`.

Implementation is split under `legacy_parts`; this module preserves the historical import path.
"""
...
_MODULES = tuple(_import_module(f"{__package__}.legacy_parts.{_name}") for _name in _MODULE_NAMES)
_EXPORTS = {}
