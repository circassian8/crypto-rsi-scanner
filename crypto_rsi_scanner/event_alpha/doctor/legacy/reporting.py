...
_CORE_OPPORTUNITY_COVERAGE_FIELDS: tuple[_CounterField, ...] = (
    ...
    ('integrated_legacy_preview_alerts_wording', 'integrated_legacy_preview_alerts_wording', None),
    ...
    ('integrated_calibration_legacy_alias_top_level', 'integrated_calibration_legacy_alias_top_level', None),
...
_NOTIFICATION_DELIVERIES_FIELDS: tuple[_CounterField, ...] = (
    ...
    ('preview_legacy_alerts_wording', 'notification_preview_legacy_alerts_wording', None),
...
def _legacy_rows_line(result: EventAlphaArtifactDoctorResult) -> str:
    return (
        "legacy rows: "
