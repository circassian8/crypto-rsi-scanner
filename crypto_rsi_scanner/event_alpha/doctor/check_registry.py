...
CHECKS: tuple[DoctorCheck, ...] = (
    ...
    _check(
        ...
        CATEGORY_OUTCOMES,
        "blocker",
        ("row_type", "profile", "artifact_namespace"),
        "Burn-in namespaces must include the daily burn-in run artifact.",
    ),
    _check(
        ...
        "warning",
        ("steps", "status"),
        "Every daily burn-in run step must record a status.",
    ),
    _check(
    ...
    _check(
        ...
        "Daily burn-in run artifacts must not claim sends, trades, paper rows, RSI rows, or triggered fades.",
    ),
    _check(
        "outcomes.daily_burn_in_integrated_preview",
        CATEGORY_OUTCOMES,
        "blocker",
        ("status", "lane_title", "rendered_item_count"),
    ...
    _check(
        ...
        CATEGORY_OUTCOMES,
        "blocker",
        ("fixture_candidate_count", "contract_counted_candidate_count", "real_burn_in_candidate_count"),
        "Burn-in scorecards must not count fixture rows as real candidate evidence.",
    ),
    _check(
        "outcomes.daily_burn_in_archive_scope",
        CATEGORY_OUTCOMES,
        "blocker",
        ("archive_scope", "included_without_burn_in_run_count"),
        "Default burn-in archives must not include non-burn-in namespaces.",
    ),
    _check(
        ...
        "warning",
        (),
        "Daily burn-in subprocess tails should explicitly record scrub flags and redaction counts.",
    ),
    _check(
        ...
        "blocker",
        (),
        "Daily burn-in subprocess tails must not persist absolute local artifact paths.",
    ),
    _check(
        ...
        "blocker",
        (),
        "Daily burn-in subprocess tails must not persist provider tokens or authorization header values.",
    ),
    _check(
        ...
        "blocker",
        (),
        "Burn-in evidence archives must block actual secret-like values while allowing safe redacted status phrases.",
    ),
    _check(
        ...
        "blocker",
        (),
        "Candidate-mode fixture smoke rows should exercise review cards and stable feedback targets.",
    ),
    _check(
        ...
        "blocker",
        (),
        "Candidate-mode manifests must carry no-send/no-trade safety counters.",
    ),
    _check(
