...
RESULT_FIELD_EXPRESSIONS: tuple[tuple[str, str], ...] = (
    ...
    ('integrated_candidate_core_decision_context_mismatch', "integrated_conflicts['integrated_candidate_core_decision_context_mismatch']"),
    ('integrated_candidate_core_decision_score_mismatch', "integrated_conflicts['integrated_candidate_core_decision_score_mismatch']"),
    ('integrated_dashboard_decision_authority_invalid', "integrated_conflicts['integrated_dashboard_decision_authority_invalid']"),
    ('integrated_candidate_expired_actionable', "integrated_conflicts['integrated_candidate_expired_actionable']"),
    ('integrated_core_expired_actionable', "integrated_conflicts['integrated_core_expired_actionable']"),
    ('integrated_preview_expired_actionable', "integrated_conflicts['integrated_preview_expired_actionable']"),
    ('integrated_dashboard_expired_actionable', "integrated_conflicts['integrated_dashboard_expired_actionable']"),
    ...
    ('integrated_candidate_card_decision_mismatch', "integrated_conflicts['integrated_candidate_card_decision_mismatch']"),
    ...
    ('integrated_api_preview_alerts_wording', "integrated_conflicts['integrated_api_preview_alerts_wording']"),
    ...
    ('integrated_calibration_api_alias_top_level', "integrated_conflicts['integrated_calibration_api_alias_top_level']"),
    ...
    ('integrated_outcome_eligibility_contract_invalid', "integrated_conflicts['integrated_outcome_eligibility_contract_invalid']"),
    ('integrated_outcome_synthetic_evidence_leak', "integrated_conflicts['integrated_outcome_synthetic_evidence_leak']"),
    ('integrated_outcome_immature_validation_claim', "integrated_conflicts['integrated_outcome_immature_validation_claim']"),
    ('integrated_outcome_duplicate_exact_identity', "integrated_conflicts['integrated_outcome_duplicate_exact_identity']"),
    ('integrated_outcome_ambiguous_exact_identity', "integrated_conflicts['integrated_outcome_ambiguous_exact_identity']"),
    ('integrated_outcome_eligible_provenance_missing', "integrated_conflicts['integrated_outcome_eligible_provenance_missing']"),
    ('integrated_outcome_identity_mismatch', "integrated_conflicts['integrated_outcome_identity_mismatch']"),
    ('integrated_outcome_decision_projection_mismatch', "integrated_conflicts['integrated_outcome_decision_projection_mismatch']"),
    ...
    ('feedback_rows_supplied', "feedback_integrity['feedback_rows_supplied']"),
    ('feedback_rows_eligible', "feedback_integrity['feedback_rows_eligible']"),
    ('feedback_rows_excluded', "feedback_integrity['feedback_rows_excluded']"),
    ('feedback_exclusion_reason_counts', "feedback_integrity['feedback_exclusion_reason_counts']"),
    ('feedback_eligibility_contract_invalid', "feedback_integrity['feedback_eligibility_contract_invalid']"),
    ('feedback_persisted_eligible_invalid', "feedback_integrity['feedback_persisted_eligible_invalid']"),
    ('feedback_legacy_rows', "feedback_integrity['feedback_legacy_rows']"),
    ('feedback_duplicate_rows', "feedback_integrity['feedback_duplicate_rows']"),
    ('feedback_future_rows', "feedback_integrity['feedback_future_rows']"),
    ('feedback_unsafe_rows', "feedback_integrity['feedback_unsafe_rows']"),
    ('feedback_missing_core_rows', "feedback_integrity['feedback_missing_core_rows']"),
    ('feedback_ambiguous_core_rows', "feedback_integrity['feedback_ambiguous_core_rows']"),
    ('feedback_superseded_rows', "feedback_integrity['feedback_superseded_rows']"),
    ('feedback_duplicate_json_keys', "feedback_integrity['feedback_duplicate_json_keys']"),
    ('feedback_invalid_jsonl', "feedback_integrity['feedback_invalid_jsonl']"),
    ('feedback_jsonl_read_errors', "feedback_integrity['feedback_jsonl_read_errors']"),
    ...
    ('live_provider_readiness_fixture_live_state_conflict', "live_provider_readiness_conflicts['live_provider_readiness_fixture_live_state_conflict']"),
    ...
    ('dex_onchain_fixture_live_state_conflict', "dex_onchain_conflicts['dex_onchain_fixture_live_state_conflict']"),
    ...
    ('cryptopanic_run_coverage_config_mismatch', "cryptopanic_conflicts['cryptopanic_run_coverage_config_mismatch']"),
    ('cryptopanic_profile_disabled_coverage_mismatch', "cryptopanic_conflicts['cryptopanic_profile_disabled_coverage_mismatch']"),
    ('cryptopanic_profile_disabled_credential_recommendation', "cryptopanic_conflicts['cryptopanic_profile_disabled_credential_recommendation']"),
    ('source_coverage_blocker_summary_inconsistent', "cryptopanic_conflicts['source_coverage_blocker_summary_inconsistent']"),
    ...
    ('legacy_rows_skipped', '0 if include_api_artifacts else raw_api'),
    ('legacy_rows_counted', 'sum((1 for row in (*runs, *alerts, *feedback, *outcomes) if event_alpha_artifacts.is_api_row(row)))'),
    ...
    ('notification_preview_api_alerts_wording', "preview_conflicts['notification_preview_api_alerts_wording']"),
    ('notification_preview_research_candidate_count_mismatch', "preview_conflicts['notification_preview_research_candidate_count_mismatch']"),
    ('notification_preview_source_snapshot_count_mismatch', "preview_conflicts['notification_preview_source_snapshot_count_mismatch']"),
    ('notification_preview_rendered_item_count_mismatch', "preview_conflicts['notification_preview_rendered_item_count_mismatch']"),
    ('notification_preview_counter_scope_mismatch', "preview_conflicts['notification_preview_counter_scope_mismatch']"),
    ('notification_preview_legacy_counter_scope_mismatch', "preview_conflicts['notification_preview_legacy_counter_scope_mismatch']"),
    ('daily_brief_counter_scope_confusion', "daily_brief_operator_conflicts['daily_brief_counter_scope_confusion']"),
    ('daily_brief_freshness_scope_missing', "daily_brief_operator_conflicts['daily_brief_freshness_scope_missing']"),
    ('daily_brief_current_core_freshness_total_mismatch', "daily_brief_operator_conflicts['daily_brief_current_core_freshness_total_mismatch']"),
    ('daily_brief_visible_core_freshness_total_mismatch', "daily_brief_operator_conflicts['daily_brief_visible_core_freshness_total_mismatch']"),
...
def build_api_doctor_result(ctx: SimpleNamespace) -> EventAlphaArtifactDoctorResult:
...
__all__ = ('RESULT_FIELD_EXPRESSIONS', 'build_api_doctor_result')
