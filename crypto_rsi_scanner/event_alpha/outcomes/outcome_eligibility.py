...
from ._outcome_eligibility_contract import (
    ...
    canonical_identity_text as _canonical_identity_text,
    finite_number,
...
def build_pending_horizon_metadata(
    *,
    observed_at: Any,
    evaluated_at: Any,
) -> dict[str, dict[str, Any]]:
    """Build an empty, truthful maturity schedule for a new Radar idea."""
