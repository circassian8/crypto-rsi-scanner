...
from ._evidence_presentation import (
    render_evidence_verdict as _render_evidence_verdict,
    validated_catalyst_attribution as _validated_catalyst_attribution,
    validated_source_independence as _validated_source_independence,
)
...
def _evidence_verdict(row: Mapping[str, Any]) -> str:
    return _render_evidence_verdict(
        row,
        definition_grid=_definition_grid,
...
def _technical_details(
    ...
    source_independence = _validated_source_independence(row)
