...
def _row_from_hypothesis(
    ...
    *,
    ...
    data.update({
        ...
        "incident_relevance_status": data.get("incident_relevance_status"),
        "incident_relevance_score": data.get("incident_relevance_score"),
        "incident_relevance_reasons": data.get("incident_relevance_reasons") or (),
        "incident_relevance_warnings": data.get("incident_relevance_warnings") or (),
        "canonical_persistence_reason": data.get("canonical_persistence_reason"),
