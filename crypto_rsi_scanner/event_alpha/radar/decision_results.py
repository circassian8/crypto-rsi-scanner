...
def build_decision_result(
    *, origin: str, primary_origin: str, origins: tuple[str, ...], bias: str,
    catalyst: str, confidence: str, timing: str, tradability: str,
    spread: str, radar_route: str, route_reason: str, actionable: bool,
    actionability: float, evidence_confidence: float, risk: float,
    urgency: float, market_phase: str, preferred_horizon: str,
    expires_at: str | None, chase_risk: float,
    ...
    return RadarDecision(
        ...
        primary_thesis_origin=primary_origin,
        thesis_origins=origins,
...
def disabled_decision(data: Mapping[str, Any]) -> RadarDecision:
    ...
    return RadarDecision(
        ...
        primary_thesis_origin=ThesisOrigin.MIXED.value,
        thesis_origins=(ThesisOrigin.MIXED.value,),
        ...
        spread_status=SpreadStatus.UNAVAILABLE.value,
        ...
        risk_score=100.0,
        urgency_score=0.0,
        market_phase=MarketPhase.ACTIVE.value,
        preferred_horizon=PreferredHorizon.ONE_TO_THREE_DAYS.value,
        expires_at=None,
        chase_risk_score=100.0,
