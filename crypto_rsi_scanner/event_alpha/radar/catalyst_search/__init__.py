"""Compatibility package for `crypto_rsi_scanner/event_alpha/radar/catalyst_search.py`.
...
_MODULE_NAMES = ('models', 'providers', 'query_builder', 'identity', 'scoring', 'ledger', 'executor', 'report', 'fixtures')
