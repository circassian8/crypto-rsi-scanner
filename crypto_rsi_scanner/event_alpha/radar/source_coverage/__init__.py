"""Compatibility package for `crypto_rsi_scanner/event_alpha/radar/source_coverage.py`.
...
_MODULE_NAMES = ('models', 'serialization', 'provider_status', 'recommendations', 'builder', 'report')
