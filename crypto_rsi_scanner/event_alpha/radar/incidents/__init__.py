"""Compatibility package for `crypto_rsi_scanner/event_alpha/radar/incidents.py`.
...
_MODULE_NAMES = ('models', 'subject_quality', 'relevance', 'linkage', 'canonical', 'store', 'report')
