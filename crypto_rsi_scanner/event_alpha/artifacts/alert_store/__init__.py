"""Compatibility package for `crypto_rsi_scanner/event_alpha/artifacts/alert_store.py`.
...
_MODULE_NAMES = ('models', 'serialization', 'snapshots', 'reconciliation', 'outcomes', 'store')
