...
_PROFILES: dict[str, EventAlphaProfile] = {
    "fixture": EventAlphaProfile(
        ...
        config_overrides={
            ...
            "EVENT_MARKET_CONTEXT_ALLOW_STALE_FIXTURE": True,
    ...
    "no_key_live": EventAlphaProfile(
        ...
        config_overrides={
            ...
            "EVENT_ANOMALY_SCANNER_ENABLED": True,
            "EVENT_CATALYST_SEARCH_ENABLED": True,
            "EVENT_CATALYST_SEARCH_PROVIDER": "rss,polymarket",
            "EVENT_CATALYST_SEARCH_PROVIDERS": ("rss", "polymarket"),
            "EVENT_WATCHLIST_ENABLED": True,
    ...
    "no_key_llm": EventAlphaProfile(
        ...
        config_overrides={
            ...
            "EVENT_ANOMALY_SCANNER_ENABLED": True,
            "EVENT_CATALYST_SEARCH_ENABLED": True,
            "EVENT_CATALYST_SEARCH_PROVIDER": "rss,cryptopanic,polymarket",
            "EVENT_CATALYST_SEARCH_PROVIDERS": ("rss", "cryptopanic", "polymarket"),
    ...
    "full_llm_live": EventAlphaProfile(
        ...
        config_overrides={
            ...
            "EVENT_LLM_MAX_PARALLEL_CALLS": 3,
    ...
    "notify_no_key": EventAlphaProfile(
        ...
        config_overrides={
            ...
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_ENABLED": True,
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_MAX_ITEMS": 3,
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_MIN_SCORE": 60.0,
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_COOLDOWN_HOURS": 0.0,
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_INCLUDE_LOCAL_ONLY": False,
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_INCLUDE_SECTOR": False,
            "EVENT_ALPHA_RESEARCH_REVIEW_DIGEST_SEND_WITH_ALERTS": False,
            ...
            "EVENT_ALPHA_TARGETED_MARKET_REFRESH_TIMEOUT_SECONDS": 5.0,
        },
        snapshot_policy="alertable",
        card_auto_write=True,
        card_write_tiers=("HIGH_PRIORITY_WATCH", "TRIGGERED_FADE", "WATCHLIST"),
...
_PROFILES["market_refresh_smoke"] = replace(
    _PROFILES["notify_llm_quality_frame"],
    name="market_refresh_smoke",
    description=(
        "Offline no-send fixture smoke proving targeted market refresh can "
        "upgrade stale-but-validated Event Alpha opportunities without creating trades."
    ),
    config_overrides={
        **_PROFILES["notify_llm_quality_frame"].config_overrides,
        "EVENT_ALPHA_NEAR_MISS_MARKET_REFRESH_ENABLED": True,
        "EVENT_ALPHA_TARGETED_MARKET_REFRESH_ENABLED": True,
        "EVENT_ALPHA_NEAR_MISS_MARKET_REFRESH_MAX_ASSETS": 20,
        "EVENT_ALPHA_TARGETED_MARKET_REFRESH_MAX_ASSETS": 20,
        "EVENT_ALPHA_NEAR_MISS_MARKET_REFRESH_TIMEOUT_SECONDS": 5.0,
        "EVENT_ALPHA_TARGETED_MARKET_REFRESH_TIMEOUT_SECONDS": 5.0,
        "EVENT_ALPHA_TARGETED_MARKET_REFRESH_PROFILE_ALLOW_FIXTURE": True,
        "EVENT_WATCHLIST_MONITOR_MARKET_SOURCE": "fixture",
        "EVENT_WATCHLIST_MONITOR_MARKET_PATH": Path("fixtures/event_discovery/market_refresh_smoke_markets.json"),
        "EVENT_MARKET_CONTEXT_ALLOW_STALE_FIXTURE": False,
        "EVENT_MARKET_CONTEXT_MAX_AGE_HOURS": 6,
        "EVENT_ALPHA_SNAPSHOT_POLICY": "all",
        "EVENT_RESEARCH_CARDS_WRITE_TIERS": (
            "STORE_ONLY",
            "RADAR_DIGEST",
