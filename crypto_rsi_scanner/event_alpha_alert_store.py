...
def _snapshot_from_route_decision(
    ...
    row = {
        ...
        **_state_cap_context(entry),
        ...
        "incident_link_status": "linked" if components.get("incident_id") else "no_incident",
        "canonical_incident_name": components.get("canonical_incident_name"),
        "event_archetype": components.get("event_archetype"),
        "primary_subject": components.get("primary_subject"),
        "affected_ecosystem": components.get("affected_ecosystem"),
        "cause_status": components.get("cause_status"),
