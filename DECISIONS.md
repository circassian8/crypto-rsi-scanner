...
`REFACTOR_*` report files may remain only as archived history and are not
regenerated by current tooling.
...
**Revisit when:** a future archival cleanup removes historical report files or
