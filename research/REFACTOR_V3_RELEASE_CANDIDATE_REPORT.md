...
- generated_at: `2026-07-05T04:18:29.416715+00:00`
...
|---:|---|---:|---:|
| 1 | `python3 tests/test_indicators.py` | `pass` | `26.808` |
| 2 | `PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 python3 -m pytest tests/event_alpha tests/rsi tests/cli tests/test_indicators.py -q` | `pass` | `27.569` |
| 3 | `python3 -m compileall -q crypto_rsi_scanner tests` | `pass` | `0.059` |
| 4 | `make refactor-size-gates PYTHON=python3` | `pass` | `1.167` |
| 5 | `make refactor-class-ownership-report PYTHON=python3` | `pass` | `1.069` |
| 6 | `make refactor-final-report PYTHON=python3` | `pass` | `1.282` |
| 7 | `make event-alpha-shim-report PYTHON=python3` | `pass` | `0.057` |
| 8 | `make event-alpha-integrated-radar-smoke PYTHON=python3` | `pass` | `1.87` |
| 9 | `make event-alpha-integrated-radar-doctor PYTHON=python3` | `pass` | `0.822` |
| 10 | `make event-alpha-notification-format-smoke PYTHON=python3` | `pass` | `2.182` |
| 11 | `make event-alpha-telegram-no-send-final-check-fast PYTHON=python3` | `pass` | `3.006` |
| 12 | `make event-alpha-coinalyze-preflight-smoke PYTHON=python3` | `pass` | `0.761` |
| 13 | `make event-alpha-coinalyze-preflight PYTHON=python3` | `pass` | `0.678` |
| 14 | `make event-alpha-coinalyze-no-send-rehearsal PYTHON=python3` | `pass` | `0.705` |
| 15 | `make event-alpha-artifact-doctor PROFILE=notify_llm_deep ARTIFACT_NAMESPACE=notify_llm_deep_cryptopanic_rehearsal STRICT=1 PYTHON=python3` | `pass` | `1.981` |
| 16 | `make verify PYTHON=python3` | `pass` | `28.312` |
