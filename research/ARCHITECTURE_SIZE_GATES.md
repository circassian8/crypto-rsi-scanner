...
|---|---|---:|
| `file_over_1500_lines` | `file:crypto_rsi_scanner/event_alpha/artifacts/schema/market_shadow_surprise.py` | 1501 |
| `file_over_1500_lines` | `file:crypto_rsi_scanner/event_alpha/dashboard/campaign_operator_actions.py` | 1624 |
| `file_over_1500_lines` | `file:crypto_rsi_scanner/event_alpha/dashboard/campaign_page.py` | 1527 |
...
| `file_over_1500_lines` | `file:crypto_rsi_scanner/event_alpha/operations/market_observation_campaign_shadow_surprise.py` | 2299 |
...
| `function_over_150_lines` | `function:crypto_rsi_scanner/event_alpha/operations/market_observation_campaign_shadow_surprise.py:validate_campaign_shadow_surprise_audit` | 163 |
...
| path | lines |
|---|---:|
| `crypto_rsi_scanner/event_alpha/operations/market_observation_campaign_shadow_surprise.py` | 2299 |
...
| `crypto_rsi_scanner/event_alpha/dashboard/campaign_operator_actions.py` | 1624 |
| `crypto_rsi_scanner/event_alpha/operations/market_no_send_features.py` | 1584 |
| `crypto_rsi_scanner/event_alpha/dashboard/campaign_page.py` | 1527 |
| `crypto_rsi_scanner/event_alpha/artifacts/schema/market_shadow_surprise.py` | 1501 |
...
| `crypto_rsi_scanner/event_alpha/radar/market_shadow_surprise.py` | 1277 |
...
| `tests/event_alpha/test_market_shadow_surprise.py` | 1396 |
...
| `tests/event_alpha/test_dashboard_campaign_operator_actions.py` | 1061 |
