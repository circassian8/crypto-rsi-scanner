...
- generated_at: `2026-07-22T00:32:04.515706+00:00`
- gate_status: `pass`
...
| `file_over_1500_lines` | `file:crypto_rsi_scanner/event_alpha/dashboard/campaign_operator_actions.py` | 2118 |
| `file_over_1500_lines` | `file:crypto_rsi_scanner/event_alpha/dashboard/campaign_page.py` | 1775 |
...
| `file_over_1500_lines` | `file:tests/event_alpha/test_market_observation_campaign.py` | 2006 |
...
| `function_over_150_lines` | `function:crypto_rsi_scanner/event_alpha/operations/market_observation_campaign_regime_audit.py:build_control_regime_generation_audit` | 217 |
| `function_over_150_lines` | `function:crypto_rsi_scanner/event_alpha/operations/market_observation_campaign_regime_audit.py:validate_control_regime_generation_audit` | 161 |
...
| `crypto_rsi_scanner/event_alpha/dashboard/campaign_operator_actions.py` | 2118 |
...
| `crypto_rsi_scanner/event_alpha/dashboard/campaign_page.py` | 1775 |
...
| `crypto_rsi_scanner/event_alpha/operations/market_observation_campaign_render.py` | 1429 |
...
| `tests/event_alpha/test_market_observation_campaign.py` | 2006 |
...
| `tests/event_alpha/test_dashboard_campaign_operator_actions.py` | 1225 |
