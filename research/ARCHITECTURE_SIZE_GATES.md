...
- generated_at: `2026-07-12T06:11:32.324101+00:00`
- gate_status: `pass`
...
| `crypto_rsi_scanner/event_alpha/outcomes/integrated_radar_outcomes.py` | 1301 |
...
| `crypto_rsi_scanner/event_alpha/artifacts/schema/registry.py` | 1199 |
| `crypto_rsi_scanner/cli/services/scanner_parts/reports.py` | 1192 |
...
| `crypto_rsi_scanner/event_alpha/artifacts/run_ledger.py` | 1129 |
...
| `crypto_rsi_scanner/event_alpha/artifacts/operator_state.py` | 1049 |
...
| `crypto_rsi_scanner/event_alpha/radar/integrated/pipeline_parts/cycle.py` | 1020 |
...
| `crypto_rsi_scanner/event_alpha/outcomes/integrated_radar_outcomes.py` | 1301 | Outcome maturation/report code is stable and below the blocker threshold. | When outcome performance views gain new sections. |
...
| `tests/event_alpha/test_operator_state.py` | 1186 |
...
| `tests/event_alpha/test_namespace_integrations.py` | 774 |
