...
- generated_at: `2026-07-19T05:13:05.295757+00:00`
- gate_status: `pass`
...
| `crypto_rsi_scanner/event_alpha/radar/market_history.py` | 1463 |
...
| `crypto_rsi_scanner/event_alpha/operations/market_no_send.py` | 1341 |
...
| `crypto_rsi_scanner/event_alpha/radar/market_history.py` | 1463 | Pure temporal baseline evaluator keeps cadence, return anchors, and feature evidence in one closed calculation path. | When adding another baseline family or changing the observation-spacing contract. |
...
| `crypto_rsi_scanner/event_alpha/operations/market_no_send.py` | 1341 | Safety-critical no-send generation orchestrator owns one bounded provider call and fail-closed publication assembly. | When adding another live-safe market provider or changing the generation transaction boundary. |
...
| `tests/cli/test_make_targets.py` | 1428 |
