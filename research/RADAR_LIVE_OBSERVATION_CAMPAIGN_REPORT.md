...
Generated at `2026-07-19T02:47:06.570231+00:00` from local artifacts only.
Research and decision support only. This report contains no trade recommendation.

## Campaign measurement

- Status: `in_progress_baseline_warming`
- Counted real/no-send cycles: `26`
- Real market observations: `780`
- Baseline-counting observations: `750`
- Too-close observations: `30`
- Real Decision candidates: `5`
- Current ideas: `0`
- Historical ideas: `5`
- Direct feature evidence: `4106`
- Proxy feature evidence: `1354`
- Pending outcomes: `3`
- Matured outcomes: `1`
...
- Current authority namespace: `radar_market_no_send_20260719t024647460963z_02a7a81ca5e2`
- Pointer target namespace: `radar_market_no_send_20260719t024647460963z_02a7a81ca5e2`
- Exact run: `2026-07-19T02:46:47.948812+00:00|no_key_live`
- Revision: `12`
...
| radar_market_no_send_20260719t024647460963z_02a7a81ca5e2 | 2026-07-19T02:46:47.948812+00:00 | 0 | none | not_published | published | dashboard_restarted | true |
...
- Current-universe retained observations: `753`
- Current-universe baseline-counted observations: `726`
...
|---|---:|---:|---:|---:|---|---|---|
| btc_eth_relative | 0 | 30 | 0 | 0 | 0-3 / 8 (30 below) | 23.99-131.49 / 31 h (1 below) | warming=30 |
| returns_1h | 29 | 1 | 0 | 0 | 6-10 / 8 (1 below) | 23.99-131.49 / 8 h (0 below) | warm=29, warming=1 |
| returns_24h | 0 | 29 | 1 | 0 | 0-3 / 8 (30 below) | 23.99-131.49 / 31 h (1 below) | cold=1, warming=29 |
| returns_4h | 29 | 1 | 0 | 0 | 5-10 / 8 (1 below) | 23.99-131.49 / 11 h (0 below) | warm=29, warming=1 |
| turnover | 30 | 0 | 0 | 0 | 16-25 / 8 (0 below) | 23.99-131.49 / 7 h (0 below) | warm=30 |
| volatility | 0 | 30 | 0 | 0 | 0-3 / 8 (30 below) | 23.99-131.49 / 31 h (1 below) | warming=30 |
| volume | 30 | 0 | 0 | 0 | 16-25 / 8 (0 below) | 23.99-131.49 / 7 h (0 below) | warm=30 |

### Retained campaign history

- Status: `warming`
- Retained observations: `780`
- Baseline-counted observations: `750`
- Too-close observations: `30`
...
| Feature group | Warm | Warming | Cold | Other | Samples min-max / required | Elapsed min-max / required | Status counts |
|---|---:|---:|---:|---:|---|---|---|
| btc_eth_relative | 0 | 31 | 3 | 0 | 0-3 / 8 (34 below) | 5.37-131.49 / 31 h (3 below) | cold=3, warming=31 |
| returns_1h | 29 | 2 | 3 | 0 | 0-10 / 8 (5 below) | 5.37-131.49 / 8 h (1 below) | cold=3, warm=29, warming=2 |
| returns_24h | 0 | 30 | 4 | 0 | 0-3 / 8 (34 below) | 5.37-131.49 / 31 h (3 below) | cold=4, warming=30 |
| returns_4h | 29 | 2 | 3 | 0 | 0-10 / 8 (5 below) | 5.37-131.49 / 11 h (1 below) | cold=3, warm=29, warming=2 |
| turnover | 31 | 3 | 0 | 0 | 2-25 / 8 (3 below) | 5.37-131.49 / 7 h (1 below) | warm=31, warming=3 |
| volatility | 0 | 31 | 3 | 0 | 0-3 / 8 (34 below) | 5.37-131.49 / 31 h (3 below) | cold=3, warming=31 |
| volume | 31 | 3 | 0 | 0 | 2-25 / 8 (3 below) | 5.37-131.49 / 7 h (1 below) | warm=31, warming=3 |
...
- Price-history rows: `780`
- Price-history SHA-256: `f3150a985c9428c78ad62065d8ac42451095bd36f8b38bc1a9f52ea1f00e8062`
...
- Candidate snapshots: `26`/`26` generations
...
- Outcome evidence statuses: `available=1, unavailable=4`
...
- **execution_quality_spread:** Trusted spread coverage is 0/780. Bybit USDT-linear perpetuals are the selected execution surface; coverage remains unavailable until a separately authorized immutable public-market capture succeeds and is bound into the campaign.
- **proxy_market_features:** The campaign retains 1354 proxy feature observations; proxy evidence remains explicitly quality-capped.
- **temporal_baseline_maturity:** The exact current authoritative universe is not feature/time-aware warm.

## Next observation

- Next eligible time: `2026-07-19T03:46:47.948812+00:00`
...
Decision Radar campaign v2 has 26 counted real/no-send cycles and 5 canonical ideas; 3 outcomes are pending and 1 outcome is matured. Provider history contains 5 provider failures and 1 blocked/preflight attempt. Baseline status is warming with 0/34 warm retained assets; exact current-universe status is warming with 0/30 warm assets. Pointer history contains 22 bound generations and current authority is radar_market_no_send_20260719t024647460963z_02a7a81ca5e2. Data-quality limitation categories are execution_quality_spread, proxy_market_features, temporal_baseline_maturity; highest-value missing input is execution_quality_spread.
