...
- generated_at: `2026-07-22T04:15:59.652988+00:00`
...
| `crypto_rsi_scanner/event_alpha/radar/decision_policy.py` | 1402 | advisory_measurement | Revisit only when cohesion, defects, or review evidence justify a split. |
| `crypto_rsi_scanner/event_alpha/radar/decision_model.py` | 1400 | advisory_measurement | Revisit only when cohesion, defects, or review evidence justify a split. |
