...
- generated_at: `2026-07-23T02:35:46.951976+00:00`
- public_class_count: `528`
- classes_over_limit_count: `6`
- functions_over_limit_count: `37`
- production_classes_over_limit: `6`
- production_functions_over_limit: `37`
- accepted_class_exceptions_count: `3`
- remaining_class_ownership_debt_count: `3`
- v3_gate_status: `pass`
- v3_auto_accept_ready: `True`
- v3_blockers: `[]`
- public_classes_not_in_own_module: `0`
- class_exceptions_remaining: `3`
- functions_over_150_lines: `37`
...
| `functions_over_150_lines` | 37 | advisory |
...
| `crypto_rsi_scanner/event_alpha/operations/execution_quality_readiness.py` | 1485 | advisory_measurement | Revisit only when cohesion, defects, or review evidence justify a split. |
...
| `crypto_rsi_scanner/event_alpha/operations/decision_review_timing.py` | 1337 | advisory_measurement | Revisit only when cohesion, defects, or review evidence justify a split. |
...
| `crypto_rsi_scanner.event_alpha.dashboard.models` | 4 | 48 | true | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.operations.market_no_send_models` | 7 | 64 | true | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.providers.dex_onchain_readiness` | 3 | 71 | true | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
| `crypto_rsi_scanner.event_alpha.providers.live_provider_readiness` | 2 | 58 | true | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.radar.market_anomaly_scanner` | 2 | 21 | true | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.lean_radar.models` | 6 | 102 | true | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.dashboard.models` | 4 | 48 | accepted_model_bundle | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.operations.market_no_send_models` | 7 | 64 | accepted_model_bundle | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.providers.dex_onchain_readiness` | 3 | 71 | accepted_model_bundle | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
| `crypto_rsi_scanner.event_alpha.providers.live_provider_readiness` | 2 | 58 | accepted_model_bundle | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.event_alpha.radar.market_anomaly_scanner` | 2 | 21 | accepted_model_bundle | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.lean_radar.models` | 6 | 102 | accepted_model_bundle | Small public DTO/enum/protocol/result bundle kept together as one stable import contract; all classes remain below the class-size limit. |
...
| `crypto_rsi_scanner.lean_radar.models` | `LeanIdea` | 102 | true | false |  |
| `crypto_rsi_scanner.lean_radar.store` | `LeanRadarStore` | 441 | true | false |  |
...
| `crypto_rsi_scanner.event_alpha.dashboard.campaign_operator_actions` | `_project_control_regime_generation_audit` | 183 | false |
...
| `crypto_rsi_scanner.event_alpha.operations.empirical_replay_core` | `_evaluate_observation` | 154 | false |
| `crypto_rsi_scanner.event_alpha.operations.empirical_validation_protocol_v2_progress` | `validate_current_progress` | 153 | true |
| `crypto_rsi_scanner.event_alpha.operations.empirical_validation_protocol_v2_progress` | `format_current_progress` | 319 | true |
...
| `crypto_rsi_scanner.event_alpha.operations.market_observation_campaign_render` | `_shadow_surprise_audit_section` | 154 | false |
...
| `crypto_rsi_scanner.event_alpha.operations.market_observation_campaign_shadow_surprise` | `validate_campaign_shadow_surprise_audit` | 167 | true |
...
| `crypto_rsi_scanner.event_alpha.operations.market_observation_campaign_shadow_surprise` | `_return_sampling_timing_summary` | 269 | false |
| `crypto_rsi_scanner.event_alpha.operations.market_observation_campaign_shadow_surprise` | `_validate_asset_feature_variation` | 153 | false |
| `crypto_rsi_scanner.event_alpha.operations.market_observation_campaign_shadow_surprise` | `_validate_return_sampling_timing_summary` | 183 | false |
| `crypto_rsi_scanner.event_alpha.radar.market_shadow_surprise` | `evaluate_shadow_temporal_surprise` | 161 | true |
...
| `crypto_rsi_scanner.lean_radar.scan` | `run_scan` | 196 | true |
