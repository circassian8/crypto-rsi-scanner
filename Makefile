...
.PHONY: test-rsi test-cli test-pytest test-pytest-safe test-pytest-timed test-pytest-parallel test-event-alpha refactor-baseline refactor-class-ownership-report refactor-size-baseline-update refactor-size-gates refactor-final-report event-alpha-namespace-lifecycle-report event-alpha-list-active-namespaces event-alpha-archive-stale-namespaces
