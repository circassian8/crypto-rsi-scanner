...
help:
	...
	@echo "  make event-alpha-telegram-no-send-final-check PROFILE=notify_llm_deep_rehearsal  Run no-send rehearsal plus final readiness/go-no-go/inbox/brief checks"
