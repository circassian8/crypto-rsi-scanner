...
.PHONY: verify-fast test-full test-rsi test-cli test-pytest test-pytest-safe test-pytest-timed test-pytest-durations test-pytest-parallel test-event-alpha architecture-baseline architecture-api-inventory architecture-class-ownership-report architecture-size-baseline-update architecture-size-gates architecture-transitional-file-check architecture-terminology-check architecture-naming-check architecture-final-report architecture-completion-map architecture-cleanliness-check event-alpha-radar-north-star event-alpha-namespace-lifecycle-report event-alpha-list-active-namespaces event-alpha-archive-stale-namespaces radar-dashboard radar-dashboard-readiness radar-dashboard-smoke radar-dashboard-ux-smoke radar-dashboard-phone-readiness radar-dashboard-phone-status radar-dashboard-phone-enable radar-dashboard-phone-disable radar-dashboard-public-readiness radar-dashboard-public-status radar-dashboard-public-enable radar-dashboard-public-disable radar-calendar-preview radar-market-no-send-readiness radar-market-no-send radar-market-no-send-smoke radar-market-campaign-report
