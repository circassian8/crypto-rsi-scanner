...
event-alpha-burn-in-scorecard:
	RSI_EVENT_ALERTS_ENABLED=0 \
	$(PYTHON) -m crypto_rsi_scanner.event_alpha.operations.scorecard --profile $(EVENT_ALPHA_RUNTIME_PROFILE) --artifact-namespace $(ARTIFACT_NAMESPACE) --days 30
...
event-alpha-burn-in-weekly-measurement:
	RSI_EVENT_ALERTS_ENABLED=0 \
	$(PYTHON) -m crypto_rsi_scanner.event_alpha.operations.measurement --profile $(EVENT_ALPHA_RUNTIME_PROFILE) --artifact-namespace $(ARTIFACT_NAMESPACE) --days 30

event-alpha-source-yield-report:
	RSI_EVENT_ALERTS_ENABLED=0 \
	$(PYTHON) -m crypto_rsi_scanner.event_alpha.operations.source_yield --profile $(EVENT_ALPHA_RUNTIME_PROFILE) --artifact-namespace $(ARTIFACT_NAMESPACE) --days 30
...
event-alpha-archive-burn-in-evidence:
	RSI_EVENT_ALERTS_ENABLED=0 \
	$(PYTHON) -m crypto_rsi_scanner.event_alpha.operations.archive --base-dir $(EVENT_ALPHA_ARTIFACT_BASE_DIR) --out-dir research
