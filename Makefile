...
.PHONY: test-rsi test-cli test-pytest test-pytest-parallel test-event-alpha refactor-baseline event-alpha-namespace-lifecycle-report event-alpha-list-active-namespaces event-alpha-archive-stale-namespaces
