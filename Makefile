...
help:
	...
	@echo "  make radar-daily-ops-readiness     Check provider cadence, dashboard ownership, and scheduler state; no writes/calls"
	@echo "  make radar-daily-ops-status        Read bounded Daily Operations state and scheduler health"
...
test-full:
	...
	$(PYTEST_SAFE_ENV) $(PYTHON) -m pytest $(PYTEST_PATHS) -q
