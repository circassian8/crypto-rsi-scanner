...
# or write normal RSI rows. The notify_no_key profile intentionally sends a
# heartbeat/exploratory digest on every clean run, so content dedupe is disabled
# while overlap/in-flight safety remains in place.
