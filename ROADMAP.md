...
|---|---|---|---|
| waiting | Let paper scoreboard accrue live data | system | `main.py --refresh-paper` on 2026-06-17 fetched 16/16 open histories and closed 4 more paper trades. Paper book is now 11 closed / 12 open; actionable is 6 trades at 33% win, control is 5 trades at 0% win, but the sample is still too small and outlier-dominated. Keep waiting. |
