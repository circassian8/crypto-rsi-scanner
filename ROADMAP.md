...
| todo | Build event-fade validation sample | open | Event-fade engine plus fixture event radar, clean CoinGecko-universe bridge, and fixture-backed Binance/Bybit announcement parsers exist. Expand reviewed dated proxy/direct/ambiguous cases with first-seen, crowding, liquidity/supply, and post-event failure labels before any live routing or paper tracking. |
...
event-fade fixture reports, event-discovery fixture/universe/exchange radar
