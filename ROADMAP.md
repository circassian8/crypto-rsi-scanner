...
| todo | Build event-fade validation sample | open | Phase 1 event-fade engine plus fixture event radar and clean CoinGecko-universe bridge exist. Expand reviewed dated proxy/direct/ambiguous cases with first-seen, crowding, liquidity/supply, and post-event failure labels before any live routing or paper tracking. |
...
event-fade fixture reports, event-discovery fixture/universe radar reports, and
suspicious-kept audit leak detection.
