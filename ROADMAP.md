...
| todo | Build event-fade validation sample | open | Event-fade engine plus fixture event radar, clean CoinGecko-universe bridge, fixture-backed Binance/Bybit announcement parsers, structured calendar/unlock parsers, and Coinalyze-style derivatives enrichment exist. Expand reviewed dated proxy/direct/ambiguous cases with first-seen, crowding, liquidity/supply, and post-event failure labels before any live routing or paper tracking. |
...
derivatives radar reports, and suspicious-kept audit leak detection.
