...
| todo | Build event-fade validation sample | open | Phase 1 event-fade engine/report exists. Collect dated proxy-event cases with first-seen, crowding, liquidity/supply, and post-event failure labels before any live routing or paper tracking. |
...
event-fade fixture reports, and suspicious-kept audit leak detection.
